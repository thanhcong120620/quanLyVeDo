...
import projectSpringboot.model.region.SetUpRegion;
...
public class LotteryBoardService implements ILotteryBoardService{
	...
	public LotteryDTO save(LotteryDTO lotteryDTO) {
		...
		SetUpRegion setUpRegion = new SetUpRegion();
		System.out.println("regionEntity.getRegionCode(): "+ regionEntity.getRegionCode());
		String drawTime = setUpRegion.setUpDrawTime(regionEntity.getRegionCode());
		System.out.println("drawTime: "+drawTime);
		regionEntity.setDrawTime(drawTime);
...
//		long region_id = lotteryBoardRepository.findRegion_idById(0);
	...
	public LotteryDTO getLotteryBoardById(long id) {
		...
		dto.setDrawTime(regionEntity.getDrawTime());
