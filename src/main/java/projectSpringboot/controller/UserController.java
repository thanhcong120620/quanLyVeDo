...
/*-----------------------------login + register + password support---------------------------------------*/	
	...
	public String newUser(@ModelAttribute("dtoUser") UserDTO dtoUser, Model model) {
		...
		try {
			...
			String errorRegister =  vf.validRegisterForm(dtoUser);
			if(errorRegister!=null) {
				model.addAttribute("errorMessage",errorRegister);
...
//		return "redirect:/UserManager";
		try {
			ValidForm vf = new ValidForm();
			String errorRegister =  vf.validRegisterForm(dto);
			if(errorRegister!=null) {
				model.addAttribute("errorMessage",errorRegister);
				System.out.println(errorRegister);
				return "userUpdate";
	...
	public String showLotteryById(@PathVariable(name="id") long id, Model model,HttpServletRequest request) {
		...
		model.addAttribute("mailUser",dto.getMailUser());
		model.addAttribute("dtoUser",dto);
		return "userUpdate";
	}
