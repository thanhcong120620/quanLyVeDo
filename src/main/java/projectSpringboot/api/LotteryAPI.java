...
public class LotteryAPI {
	 ...
	 * test query native
	 * */
	@GetMapping(value = "/api/lotteryBoard2/index")
	public IndexDTO findByDateAndRegion() {
		IndexDTO indexDTO = staticService.displayYesterday("6-12-2022");
		System.out.println("indexDTO by LotteryBoard: ");
	...
	public void deleteLB(@RequestBody String idList) throws UserNotFoundException {
