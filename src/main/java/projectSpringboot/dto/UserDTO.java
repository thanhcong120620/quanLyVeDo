...
public class UserDTO extends AbstractDTO<UserDTO>{
	...
	public String toString() {
		return "UserDTO [codeDrawCH=" + codeDrawCH + ", province=" + province + ", dayCH=" + dayCH + ", monthCH="
				+ monthCH + ", yearCH=" + yearCH + ", status=" + status + ", nameUser=" + nameUser + ", genderUser="
				...
				+ ", roleUser=" + roleUser + ", userNameOrPhone=" + userNameOrPhone + "]";
	}
